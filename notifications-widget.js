...
(function () {
  ...
  const INSTALL_BTN = {
    ...
    /* ── حاسبة: يظهر بجانب زر الإشعارات أفقياً ── */
    desktop_gap:    "10px",    /* المسافة بينه وبين زر الإشعارات */
    desktop_size:   "14px",   /* حجم الخط */
    desktop_pad:    "9px 14px", /* الحشوة */

    /* ── موبايل: يظهر أسفل زر الإشعارات عمودياً ── */
    mobile_gap:     "6px",    /* المسافة بينه وبين زر الإشعارات */
    mobile_size:    "12px",   /* حجم الخط */
    mobile_pad:     "7px 11px", /* الحشوة */
    mobile_align:   "flex-start", /* محاذاة من اليسار */
  };
      ...
      left.innerHTML =
        ...
        '@media(max-width:820px){' +
          ...
          '#btnInstallApp{' +
            ...
            'display:inline-flex!important;' +
            'align-self:' + INSTALL_BTN.mobile_align + '!important;' +
            'margin-left:0!important;' +
          '}' +
        '}' +
        '</style>' +
        '<button id="btnEnableNotifications" type="button" style="display:none;">' + NOTIF_BTN.text + '</button>' +
        '<button id="btnInstallApp" type="button" style="display:none;">' + INSTALL_BTN.text + '</button>';
