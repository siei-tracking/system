...
(function () {
  ...
  function buildWidget() {
    ...
    /* ── زر تفعيل الإشعارات — مستقل ── */
if (!$("nwNotifBtnWrap")) {
  const notifWrap = document.createElement("div");
  notifWrap.id = "nwNotifBtnWrap";
  notifWrap.innerHTML =
    '<style>' +
    '#nwNotifBtnWrap{' +
      'position:absolute;' +
    ...
    '}' +
    '#btnEnableNotifications.nw-lbtn:hover{transform:translateY(-1px);opacity:.92;}' +
    ...
    '}' +
    '</style>' +
    '<button id="btnEnableNotifications" class="nw-lbtn" type="button" style="display:none;">' + NOTIF_BTN.text + '</button>';

  header.appendChild(notifWrap);
}


/* ── زر تثبيت التطبيق — مستقل ── */
if (!$("nwInstallBtnWrap")) {
  const installWrap = document.createElement("div");
  installWrap.id = "nwInstallBtnWrap";
  installWrap.innerHTML =
    ...
    '#btnInstallApp.nw-lbtn{' +
      ...
      'display:none;align-items:center;gap:6px;' +
    '}' +
    '#btnInstallApp.nw-lbtn:hover{transform:translateY(-1px);opacity:.92;}' +
    '@media(max-width:820px){' +
      '#nwInstallBtnWrap{' +
        'position:fixed!important;' +
    ...
    '}' +
    '</style>' +
    '<button id="btnInstallApp" class="nw-lbtn" type="button" style="display:none;">' + INSTALL_BTN.text + '</button>';

  header.appendChild(installWrap);
}
